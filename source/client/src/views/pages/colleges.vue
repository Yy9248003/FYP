<template>
	<div class="fater-body-show">
        <Card>
			...
			<div>
				<Form :model="qryForm" inline>
					<FormItem prop="name">
						<Input type="text" v-model="qryForm.name" placeholder="学院名称……"></Input>
					</FormItem>
					<FormItem>
        ...
        <Modal v-model="showAddFlag"
			...
			<Form :label-width="80" :model="collegeForm">
				<FormItem label="学院名称">
					<Input v-model="collegeForm.name" placeholder="请输入学院名称..."></Input>
				</FormItem>
			</Form>
		</Modal>
...
export default{
    ...
    data(){
        return {
            ...
            columns: [
                ...
                {title: '学院名称', key: 'name', align: 'center'},
    ...
    methods:{
		...
		getPageInfo(pageIndex, pageSize) {
            ...
            getPageColleges(pageIndex, pageSize, 
        ...
        addInfo() {
            ...
            addColleges(this.collegeForm).then(resp => {
        ...
        updInfo() {
            ...
            updColleges(this.collegeForm).then(resp => {
